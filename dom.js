...
define(function(require, exports, module) {
    ...
    $.each = function(obj, func) {
        if (!exports.decide("isArray", obj) || !exports.decide("isPlainObject", obj))
    ...
    $.fn = $.prototype = {
        ...
        attr: function(at, val) {
            if (val) {
                for (var i = 0; i < this.elems.length; i++) {
                    this.elems[i].setAttribute(at, val);
                }
            } else {
                return this.elems[0].getAttribute(at);
            }
            return this
        }
